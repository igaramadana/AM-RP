Config = {
	...
	disableAtSpeed = 200, -- Max speed (m/s) limit to disable driveby aiming       (Set to 0.0 or very high to allow at any speeds)
	-- Default: ~60 MPH            Conversation:      m ' 2.237 for MPH    m ' 3.6 for KPH
	...
	autoActivate = true,    -- Automatically activate custom camera when player enters a vehicles
	fpOnly = false,         -- Restricts the driveby camera to first-person        (Note:  This will override allowVehCam)
...
-- Camera Mode 2: Use this to disable (0) certain vehicles and to specify custom (2) vehicles
